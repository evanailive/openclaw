...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option("--volcengine-api-key <key>", "Volcengine (火山引擎) API key")
    .option("--dashscope-api-key <key>", "Aliyun DashScope (阿里云百炼) API key")
        ...
        await onboardCommand(
          {
            ...
            dashscopeApiKey: opts.dashscopeApiKey as string | undefined,
            gatewayPort:
